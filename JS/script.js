    ...
    div.innerHTML = `
        <div class = "p-6 lg:p-12 flex gap-6 lg:flex-row flex-col items-center lg:items-start bg-[#F3F3F5] rounded-3xl">
            ...
            <div class = "space-y-4 w-full">
                ...
                <hr class = "w-full border border-dashed border-gray-300">
...
const handleSearchByCategory = () => {
  const searchCategory = document.getElementById("searchPosts").value;
  loadAllPosts(searchCategory);
};
